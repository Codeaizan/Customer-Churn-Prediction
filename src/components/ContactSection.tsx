...
const ContactSection = () => {
  ...
  const resources = [
    ...
    { title: "Technical Report", url: "https://github.com/Codeaizan/Customer-Churn-Prediction/blob/main/data/Updated_Churn_Report_With_Enhancements.pdf", description: "Detailed methodology and results analysis" },
